...
public sealed partial class MidiSequence
{
    ...
    public MidiSequence(Stream stream)
    {
        ...
        Load(stream, 0, MidiSequenceLoopType.None);
    ...
    public MidiSequence(Stream stream, int loopPoint)
    {
        ...
        Load(stream, loopPoint, MidiSequenceLoopType.None);
    ...
    private void Load(Stream stream, int loopPoint, MidiSequenceLoopType loopType)
    {
