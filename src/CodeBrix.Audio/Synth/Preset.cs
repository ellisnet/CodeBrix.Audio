...
public sealed class Preset
{
    ...
    private Preset(PresetInfo info, Zone[] zones, SoundFontInstrument[] instruments)
    {
        this.name = info.Name;
    ...
    internal static Preset[] Create(PresetInfo[] infos, Zone[] zones, SoundFontInstrument[] instruments)
    {
        if (infos.Length <= 1)
        {
