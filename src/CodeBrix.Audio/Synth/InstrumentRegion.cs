...
public sealed class InstrumentRegion
{
    ...
    private InstrumentRegion(SoundFontInstrument instrument, Zone global, Zone local, SampleHeader[] samples) : this()
    {
    ...
    internal static InstrumentRegion[] Create(SoundFontInstrument instrument, Span<Zone> zones, SampleHeader[] samples)
    {
