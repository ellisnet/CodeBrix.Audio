...
public sealed class SoundFont
{
    ...
    private SoundFontInstrument[] instruments;
    ...
    /// </summary>
    public IReadOnlyList<SoundFontInstrument> Instruments => instruments;
    ...
    internal SoundFontInstrument[] InstrumentArray => instruments;
}
