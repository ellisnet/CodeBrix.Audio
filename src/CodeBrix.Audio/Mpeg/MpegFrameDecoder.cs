...
internal class MpegFrameDecoder
{
    ...
    /// <list type="bullet">
    /// <item>
    /// <description>For <see cref="CodeBrix.Audio.Mpeg.StereoMode.Both"/>, sample data on both two channels will occur in turn (left first).</description>
    /// </item>
    /// <item>
    /// <description>For <see cref="CodeBrix.Audio.Mpeg.StereoMode.LeftOnly"/> and <see cref="CodeBrix.Audio.Mpeg.StereoMode.RightOnly"/>, only data on
    /// specified channel will occur.</description>
    /// </item>
    /// <item>
    /// <description>For <see cref="CodeBrix.Audio.Mpeg.StereoMode.DownmixToMono"/>, two channels will be down-mixed into single channel.</description>
    /// </item>
    /// </list>
    /// </summary>
    /// <param name="frame">The Mpeg frame to be decoded.</param>
