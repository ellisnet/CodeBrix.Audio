...
using CodeBrix.Audio.Engine.Editing.Mapping;
using CodeBrix.Audio.Engine.Enums;
using CodeBrix.Audio.Engine.Midi.Modifier;
using CodeBrix.Audio.Engine.Modifiers;
using CodeBrix.Audio.Engine.Security.Analyzers;
using CodeBrix.Audio.Engine.Security.Configuration;
using CodeBrix.Audio.Engine.Security.Models;
using CodeBrix.Audio.Engine.Security.Modifiers;
using CodeBrix.Audio.Engine.Security.Payloads;
using CodeBrix.Audio.Engine.Visualization;

namespace CodeBrix.Audio.Engine.Editing.Persistence;  //was previously: SoundFlow.Editing.Persistence

/// <summary>
/// Source-generated JSON context for CodeBrix.Audio.Engine project persistence.
...
internal partial class CompositionProjectJsonContext : JsonSerializerContext;