...
using CodeBrix.Audio.Engine.Metadata.Midi;
using CodeBrix.Audio.Engine.Midi.Abstracts;
using CodeBrix.Audio.Engine.Midi.Interfaces;
using CodeBrix.Audio.Engine.Midi.Routing.Nodes;
using CodeBrix.Audio.Engine.Providers;
using CodeBrix.Audio.Engine.Security;
        ...
        IJsonTypeInfoResolver? customTypeResolver = null)
    {
        ...
        var jsonOptions = new JsonSerializerOptions
        {
            ...
            TypeInfoResolver = customTypeResolver != null
                ? JsonTypeInfoResolver.Combine(CompositionProjectJsonContext.Default, customTypeResolver)
