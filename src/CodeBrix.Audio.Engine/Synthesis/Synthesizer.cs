...
using CodeBrix.Audio.Engine.Midi.Enums;
...
using CodeBrix.Audio.Engine.Synthesis.Interfaces;
using CodeBrix.Audio.Engine.Synthesis.Voices;

namespace CodeBrix.Audio.Engine.Synthesis;  //was previously: SoundFlow.Synthesis
