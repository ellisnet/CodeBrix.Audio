...
using CodeBrix.Audio.Engine.Synthesis.Generators;
using CodeBrix.Audio.Engine.Synthesis.Instruments;
using CodeBrix.Audio.Engine.Synthesis.Interfaces;

namespace CodeBrix.Audio.Engine.Synthesis.Voices;  //was previously: SoundFlow.Synthesis.Voices
