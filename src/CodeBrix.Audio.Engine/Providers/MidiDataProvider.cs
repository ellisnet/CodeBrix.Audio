using CodeBrix.Audio.Engine.Editing;
using CodeBrix.Audio.Engine.Metadata.Midi;
using CodeBrix.Audio.Engine.Metadata.Midi.Enums;
using MidiTrack = CodeBrix.Audio.Engine.Metadata.Midi.MidiTrack;

namespace CodeBrix.Audio.Engine.Providers;  //was previously: SoundFlow.Providers
