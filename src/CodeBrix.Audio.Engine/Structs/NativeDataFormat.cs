...
namespace CodeBrix.Audio.Engine.Structs;  //was previously: SoundFlow.Structs
...
/// Can be used by reading an array from a pointer to `NativeDataFormats` of <see cref="CodeBrix.Audio.Engine.Structs.DeviceInfo"/> struct.
/// </remarks>
