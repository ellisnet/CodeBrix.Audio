namespace CodeBrix.Audio.Engine.Security.Configuration;  //was previously: SoundFlow.Security.Configuration
...
public class WatermarkConfiguration
{
    ...
    /// </summary>
    public string Key { get; set; } = "DefaultCodeBrixAudioKey";
