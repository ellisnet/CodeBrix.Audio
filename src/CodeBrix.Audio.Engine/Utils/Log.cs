...
/// <summary>
/// Provides a centralized, decoupled logging mechanism for the CodeBrix.Audio.Engine library.
/// End-users can subscribe to the static OnLog event to capture and handle log messages.
/// </summary>
public static class Log
{
    /// <summary>
    /// Occurs when the CodeBrix.Audio.Engine library generates a log message.
