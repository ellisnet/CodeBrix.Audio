...
------------------------------------------------------------------
  ...
  src/CodeBrix.Audio.ModestSynth/AGENT-README.txt
      ...
      standalone parameter model for them, one call that hands them to the
      sampler engine, and a complete General MIDI sound set - synthesizer, bank
      and instrument library - made entirely by synthesis. Built and published
