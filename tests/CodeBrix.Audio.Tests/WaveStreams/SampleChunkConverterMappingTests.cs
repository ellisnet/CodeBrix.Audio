...
public class SampleChunkConverterMappingTests
{
    ...
    public void Mono16ConverterMapsPcmToStereoFloat()
    {
        ...
        Assert.Equal(0.5f, left, 1e-6f);
        Assert.Equal(0.5f, right, 1e-6f);
    }
    ...
    public void Stereo24ConverterMapsPcmToStereoFloat()
    {
        ...
        Assert.Equal(8, bytesRead);
        Assert.Equal(-1.0f, left, 1e-6f);
        Assert.Equal(8388607f / 8388608f, right, 1e-6f);
    }
    ...
    public void MonoFloatConverterMapsToStereoFloat()
    {
        ...
        Assert.Equal(8, bytesRead);
        Assert.Equal(0.25f, left, 1e-6f);
        Assert.Equal(0.25f, right, 1e-6f);
    }
    ...
    public void StereoFloatConverterMapsToStereoFloat()
    {
        ...
        Assert.Equal(8, bytesRead);
        Assert.Equal(-0.75f, left, 1e-6f);
        Assert.Equal(0.125f, right, 1e-6f);
    }
    ...
    public void Stereo8ConverterShouldMapUnsignedPcmAroundZero()
    {
        ...
        Assert.Equal(8, bytesRead);
        Assert.Equal(-1.0f, left, 1e-6f);
        Assert.Equal(255f / 128f - 1f, right, 1e-6f);
    }
